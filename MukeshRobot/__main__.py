...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="• Hᴏᴍᴇ •", callback_data="aboutkanekii")]
                ]
            ),
        )
